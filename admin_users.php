...
if(isset($_GET['delete'])){
   ...
   mysqli_query($conn, "DELETE FROM `tbl_users` WHERE id = '$delete_id'") or die('query failed');
...
<body>
    ...
    <section class="users">
        ...
        <div class="box-container">
            <?php
         $select_users = mysqli_query($conn, "SELECT * FROM `tbl_users`") or die('query failed');
