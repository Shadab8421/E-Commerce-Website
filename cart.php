...
<body>
    ...
    ?>
            <div class="box">
                ...
                <div class="product_offer">Offer <?php echo $fetch_cart['product_offer']; ?> % off*</div>
                ...
                <?php $offer = ($fetch_cart['price'] / 100) * ($fetch_cart['product_offer']) ; ?>
                <?php $total =  ($fetch_cart['price'] * $fetch_cart['quantity']); ?>
                <?php $sub_total = $total - $offer * $fetch_cart['quantity'] ;?>
